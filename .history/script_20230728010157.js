...
async function edit(id)
{
    ...
    document.getElementById('txId').value = result.id
    document.getElementById('txFirstName').value = result.firstName
    document.getElementById('txSecondName').value = result.secondName
    document.getElementById('txAge').value = result.age
    document.getElementById('txAddress').value = result.address
    document.getElementById('txDateBirth').value = result.dateOfBirth
    document.getElementById('txPhoneNumber').value = result.phoneNumber
    document.getElementById('txFoto').value = result.urlFoto
...
{   
    var data ={
        ...
        "firstName": document.getElementById('txFirstName').value,
        "secondName": document.getElementById('txSecondName').value,
        "age": document.getElementById('txAge').value,
        "address": document.getElementById('txAddress').value,
        "dateOfBirth": document.getElementById('txDateBirth').value,
        "phoneNumber": document.getElementById('txPhoneNumber').value,
        "urlFoto": document.getElementById('txFoto').value,
    }
    ...
    var url = URL_API + 'DatosContacto/' + data.id
    await fetch(url, {
    "method": 'PUT',
    "body": JSON.stringify(data),
    "headers": {
