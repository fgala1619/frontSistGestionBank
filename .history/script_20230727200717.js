...
async function edit(id)
{
   ...
   const body ={
    "id": document.getElementById('txtId').value = result.id
    "firstName": document.getElementById('txtFirstName').value = result.firstName
    "secondName": document.getElementById('txtSecondName').value = result.secondName
    "age": document.getElementById('txtAge').value = result.age
    "address": document.getElementById('txtAddress').value = result.address
    "dateOfBirth": document.getElementById('txtDateBirth').value = result.dateOfBirth
    "phoneNumber": document.getElementById('txtPhoneNumber').value = result.phoneNumber
    "urlFoto": document.getElementById('txtFoto').value = result.urlFoto
   }
